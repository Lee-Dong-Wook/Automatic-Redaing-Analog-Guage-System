...
#include "candidate.hpp"						// 후보영역 개선 및 후보영상 생성 함수
...
int main()
{
	...
	knn[0] = kNN_train("../trainImage/trainimage/train_numbers2001.png", K1, 10, 20);
	knn[1] = kNN_train("../trainImage/trainimage/train_texts.png", K2, 25, 20);
	...
	cout << "차량 영상 번호 (0-20) : ";
	cin >> car_no;
	string fn = format("../trainImage/test_car/%02d.jpg", car_no);
